...
[lam0, xi, x_plus, pn, g_red, gx, gy, Hxx, Hyy, Hxy, H_red, Jr,x_idx, EE, Hi, Cx, Cy, gk, Jk, Hk] = deal(cell(Nregion,1));
...
t_acc = t_acc+logg_hdsqp.et.total;
end
t_acc = t_acc/NN;
for i=1:iter_max
...
for i = 1:logg.iter
    ...
    dx_aladin(i) = norm(logg.X(:,i) - xx0,2);
end
t_aladin = [0;t_aladin];
