...
\begin{figure}
    ...
    \begin{tikzpicture}[%
      ...
      \node {\textbf{Original Problem~\ref{eq:dist-power-flow-problem}}}
        child { node {\textbf{Distributed Feasibility Problem}~\ref{eq:dist-feasibility-problem}}
            child { node{ADMM}
        ...
        child [missing] {}
        child [missing] {}	
        child { node {\textbf{Distributed Least-squares Problem}~\ref{eq:dist-least-squares-problem}}
            child { node{ADMM}
                child { node{CasADi with Ipopt}}
            }
            child [missing] {}
    ...
    \end{tikzpicture}
    \caption{Algorithm tree}
    \label{fig:Algorithm-tree}
\end{figure}
\end{document}
