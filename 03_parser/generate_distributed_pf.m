function problem = generate_distributed_pf(mpc, names, problem_type)
% generate_distributed_pf
%
...
%   See also: [run_case_file_splitter](run_case_file_splitter.md)
    ...
    for i = 1:N_regions
        ...
        [cost, inequality, equality, x0, pf, bus_spec, Jac, grad, Hessian, state, dim] = build_local_pf(mpc.(names.split){i}, names, num2str(i), problem_type);
