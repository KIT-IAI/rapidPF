function problem = generate_distributed_problem_for_aladin(mpc, names, problem_type, state_dimension)
...
%   See also: [run_case_file_splitter](run_case_file_splitter.md)
    problem = generate_distributed_problem(mpc, names, problem_type, state_dimension);
