function test_file_UI(type, casefile, gsk, algorithm, solver)
    clc
%    clear
    close all
    ...
    alpha                = gsk;
    [mpc_trans,mpc_dist] = gen_shift_key(matpower_casefile, alpha); % P = P * 0.2
...
%     problem_type = 'least-squares';
    ...
    opts = struct('maxiter',20, 'solveQP','MA57');
    opts.reg ='false';
    % opts.rho0= 1e1;
    % opts.regParam = 1e-12;
